...
function displayCart() {
    ...
    if (products === null || produitLocalStorage == 0) {  // si products est null ou égale à 0 
        console.log("cart vide");
    } else {
      //  console.log("cart products présent");

    for (let prod in products) { // Boucler sur les produits du panier
        ...
        image.src = products[prod].product.imageUrl;    //<img src="../images/product01.jpg" alt="Photographie d'un canapé">
        image.alt = products[prod].product.altTxt;
